...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.1.0-rc5.zip",
            checksum: "753e38152bc795f6f5e7835eebc30fc244f934afc5a9099ce3ff866f815fe72d"
        ),
        .target(
