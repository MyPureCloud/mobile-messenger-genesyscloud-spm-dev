...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.2.0-rc1.zip",
            checksum: "7ec5d3af420a450c3ff1cb8e4f6d653647cf487c6fca782db5d21c7b1fb65fd0"
        ),
        .target(
