...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.1.0-rc7.zip",
            checksum: "aaa690e2a07d0bc428bd9572081758df46c0c0e677f82b3175dfb9a0f7765b93"
        ),
        .target(
