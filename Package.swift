...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.1.0-rc6.zip",
            checksum: "8217a4850f687da9cba677f5122b5c475dedb256975b3cc3a5fc482bc1011254"
        ),
        .target(
