...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.2.0-rc3.zip",
            checksum: "e47bb88416441ad690657b91d284454c1332d5e65c7cb835d7242a81f98c59f4"
        ),
        .target(
