...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.1.0-rc8.zip",
            checksum: "a0115225902d2e27b44f40d93faa449e08380ea387587edc7459c12d84df6205"
        ),
        .target(
