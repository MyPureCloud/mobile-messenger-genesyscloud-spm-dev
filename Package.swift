...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.1.0-rc4.zip",
            checksum: "75c24917ee3542fa67581ea4ccfb75f3b11a40407919530e81af0b171a1050fe"
        ),
        .target(
