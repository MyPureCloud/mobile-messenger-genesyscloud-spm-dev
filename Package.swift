...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.1.0-SNAPSHOT-pr-184-4.zip",
            checksum: "ace4adba91725352a1cf84f840d24ae3049b3b098e043d1eb4961ce3ea3ce363"
        ),
        .target(
