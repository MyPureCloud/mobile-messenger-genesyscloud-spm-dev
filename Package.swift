...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.2.0-rc2.zip",
            checksum: "ea92cfe47c3614f5c6ca37cf836a42e2a8284a73b951b07be4b9ae9f60367a4f"
        ),
        .target(
